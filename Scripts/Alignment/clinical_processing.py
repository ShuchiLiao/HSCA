...
try:
    from .clinical_registry import VariableSpec
...
def merge_clinical_and_technical_covariates(
    clinical_clean_df: pd.DataFrame,
    technical_df: pd.DataFrame,
) -> pd.DataFrame:
    """Merge cleaned clinical variables with patient-level technical covariates."""
    ...
    merged = left.merge(right, on="patient_id", how="left", validate="1:1")
...
__all__ = [
    "detect_patient_id_col",
    "normalize_patient_id",
    "coerce_numeric_series",
    "clean_binary_01",
    "clean_ordinal_default",
    "clean_nyha",
    "clean_procedure_category",
    "clean_text_series",
    "apply_variable_registry",
